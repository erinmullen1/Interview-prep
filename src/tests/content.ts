  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 0,
        explanation: 'Functional updates are the safe default whenever new state depends on previous state.',
      },
      {
...
fakeSaveApi().catch(() => setTodos(previous))`,
        ...
        answer: 0,
        explanation: 'Full-snapshot rollback is simple and correct for one change at a time, but concurrent updates need a targeted, per-item revert.',
      },
      {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          'A fully RFC-5322-compliant regex is a rabbit hole; a loose check catches typos and the real verification is a confirmation email',
          'Strict regexes are slower than network requests',
          'Loose regexes are required for aria-invalid to work',
        ],
        answer: 1,
        explanation: 'Overly strict email validation rejects valid edge-case addresses and still cannot prove the inbox exists.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 1,
        explanation: 'Interviewers want you to know the tool and when it is premature optimization.',
      },
      {
    ...
    questions: [
      {
        ...
        answer: 1,
        explanation: 'Roving tabindex: the active tab has tabIndex 0, the rest -1, so Tab jumps past the tablist in one stop.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 1,
        explanation: 'O(n) per drop, fine for realistic list sizes, and simpler than index-math swaps.',
      },
      {
